...
# rho (density) [19] and c_s (speed of sound) [20] vs. V_T (true air speed) [22]
# With a colourbar of wind, W_N, W_E, W_D [31:34]

fig, ax = plt.subplots()

ax.plot(res.t, res.y[:, 22], label=all_cols[22])
ax.plot(res.t, res.y[:, 31:34], label=all_cols[31:34])
